...
case "$DEPLOY_ENVIRONMENT" in
	...
	functional_test)
		...
		sh -c "npm install --prefix application/hello-world; SERVER_PORT=3003 nohup node application/hello-world/hello_world.js &>/dev/null"
		;;
	...
	user_acceptance)
		...
		echo "Number of machines set to 2"
		sh -c "npm install --prefix application/hello-world; SERVER_PORT=3002 nohup node application/hello-world/hello_world.js &>/dev/null"
		;;
	...
	staging)
		...
		sh -c "npm install --production --prefix application/hello-world; SERVER_PORT=3001 nohup node application/hello-world/hello_world.js &>/dev/null"
		;;
	...
	production)
		...
		sh -c "npm install --production --prefix application/hello-world; SERVER_PORT=3000 nohup node application/hello-world/hello_world.js &>/dev/null"
		;;
